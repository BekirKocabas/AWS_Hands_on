...
- discuss about how to connect to the "bekir-az1b-private-subnet" instance
...
- Select bekir-nat-gateway --- > Actions ---> delete Nat Gateway
...
- Go to Route Table and select "bekir-private-rt"
