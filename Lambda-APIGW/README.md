...
- Create a bucket of `bekir.source.lambda` with following properties,

```text
Bucket name                 : bekir.source.lambda
Region                      : N.Virginia
...
- Create another bucket of `bekir.destination.lambda` with following properties,

```text
Bucket name                 : bekir.destination.lambda
Region                      : N.Virginia
Block all public access     : Checked (KEEP BlOCKED)
Versioning                  : Disabled
Tagging                     : 0 Tags
...
def lambda_handler(event, context):
   destination_bucket_name = 'bekir.destination.lambda'
...
- Select S3 bucket named 'bekir.source.lambda'

- Upload any files to source bucket

- Go to the S3 bucket named 'bekir.destination.lambda' and show the uploaded files to the source bucket.
