...
sudo file -s /dev/xvdf -> xvdf yeni devicein adi. filesistemi var mi ona bakacaz
# Format the new volume.
sudo mkfs -t ext4 /dev/xvdf -> ext4 dosya sistemi kuracak
# Check the format of the volume again after formatting.
sudo file -s /dev/xvdf -> tekrar baktigimizda ext4 dosya sistemini görüyoruz
