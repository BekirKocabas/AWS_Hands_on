...
4. Create EC2 in VPC of  "bekir-vpc-a" named "Local"

```bash 
Region: "N.Virginia"
VPC: 'bekir-vpc-a'-public 
Subnet: PublicA
...
```
5. Create "Windows" instance in VPC of  "bekir-vpc-a" named "Windows"
...
```bash
   Domain name: the same name of your domain(bekirkocabas.click)
   Description: ---
...
- type "www.bekirkocabas.click". show which content is seen "local instance content" in VPC 
- go to the public browser than type browser: "www.bekirkocabas.click" than show that, N.Virginia instance is seen on public internet.
