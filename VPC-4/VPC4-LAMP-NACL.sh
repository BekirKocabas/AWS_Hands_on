...
# 3.Create MariaDB ec2 instance in Private Subnet 1b
   ...
   VPC: "bekir-vpc-a"
   Subnet: "bekir-az1b-private-subnet"
...
# 13. Edit "bekir-private-rt" route table:
...
# 19. Create new database named "bekirdb".
CREATE DATABASE bekirdb;

# 20. Create a user named "admin".
CREATE USER admin IDENTIFIED BY '123456789';

# 21. Grant permissions to the user "admin" for database "bekirdb".
GRANT ALL ON bekirdb.* TO admin IDENTIFIED BY '123456789' WITH GRANT OPTION;  
...
# 4. Select Subnet associations sub-menu ---> Edit subnet association ---> select "bekir-az1a-private-subnet" ---> edit
...
# 6. Go to the NACL named "bekir-private1a-nacl"
...
# 10. Go to the NACL named "bekir-private1a-nacl"
